...
<body class="login-page">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Se connecter à NewSchool</h2>
						</div>
                        <form method="POST" action="{{ route('login') }}">
							...
							<div class="input-group custom">
								<input type="email" class="form-control form-control-lg" name="email" placeholder="votre email " :value="old('email')" required autofocus>
	...
	<script src="{{asset('assets/src/plugins/cropperjs/dist/cropper.js')}}"></>
</body>
</html>