...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>NewSchool - Mot de passe oublié</title>
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<h6 class="mb-20">Entrez votre E-mail pour reinitialiser votre mot de passe</h6>
							...
							<div class="row align-items-center">
								<div class="col-5">
									<div class="input-group mb-0">
										...
										-->
										<button type="submit" class="btn btn-primary btn-lg btn-block" >Reinitialiser</button>
									</div>
								</div>
								<div class="col-2">
								...
								<div class="col-5">
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="{{route('login')}}">Connexion</a>
									</div>
								</div>
							</div>
						</form>
