...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>NewSchool -Dashboard </title>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="{{asset('assets/vendors/images/deskapp-logo.svg')}}" alt="logo"></div>
		...
		<div class="right-sidebar-body customscroll">
			...
			<div class="pd-20 card-box mb-30">
				...
				<div class="clearfix mb-20">
					<div class="pull-left">
						<h4 class="text-blue h4">Année scolaire</h4>
					</div>
					<div class="pull-right">
						<a href="#" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-backdrop="static" data-toggle="modal" data-target="#login-modal" type="button">Ajouter</a>
					</div>
				</div>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-folder-5 fa-2x"></span><span class="mtext">Classe</span>
						</a>
						<ul class="submenu">
							<li><a href="{{route('listeclasse')}}">Liste classes</a></li>
							<li><a href="advanced-components.html">Inscriptions</a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="400.html">Professeurs</a></li>
							<li><a href="403.html">Personnel Administration</a></li>
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			@yield('content')
			@include('users.prof.classe.options.annee')
